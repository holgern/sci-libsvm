...
table = ["libsvmread", "sci_libsvmread"; ...
            "libsvmwrite", "sci_libsvmwrite"; ...
			 ...
			 "libsvm_savemodel", "sci_svmsavemodel";...
			 "libsvm_loadmodel", "sci_svmloadmodel";...
             ];


files = [ "libsvmread.c","libsvmwrite.c","svm.cpp","svmtrain.c","svm_model_scilab.c","svmpredict.c",..
          "tron.cpp", "linear.cpp", "train.c", "predict.c","linear_model_scilab.c", "svmsavemodel.c", "svmloadmodel.c"];
